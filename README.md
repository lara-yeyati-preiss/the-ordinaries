...
The site opens with a **scrollytelling** sequence introducing embroidered samplers as examples of how domestic craft reflected learning, order, and social values.
This story expands to other forms of making and use, showing how the material remains of daily habits can reveal glimpses of what once constituted an ordinary life.

Objects are then organized in a **zoomable treemap** that can be explored by **action family** or **material** (toggleable).
...
- **Processing**: Descriptions cleaned and parsed in Python; materials extracted using regex. Objects classified by main action through a hybrid approach combining LLM tagging and manual review.
